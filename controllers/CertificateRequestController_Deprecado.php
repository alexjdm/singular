...
include_once("models/DAO/CertificadoSolicitud_DAO.php");
...
class CertificateRequestControllerDeprecado {
    ...
    {
        $this->model = new CertificadoSolicitud_DAO();
    ...
    public function createNewCertificateRequest() {
        ...
        return $this->model->newCertificateRequest($idAsegurado, $idTipoMercaderia, $idPoliza, $aFavorDe, $tipo, $origen, $destino, $via, $fechaEmbarque, $transportista, $naveVueloCamion, $blAwbCrt, $referenciaDespacho, $idMateriaAsegurada, $detalleMercaderia, $idEmbalaje, $montoAseguradoCIF, $tasa, $primaMin, $primaSeguro, $observaciones, $estado);
    }
