...
class Usuario
{
    ...
    {
        $uDao = new Usuario_DAO();
        return $uDao -> changePasswordUser($idUsuario, $password);
    }

    public function newUser($nombre, $rut, $apellido, $correo, $idCargo, $idCorredora, $idPerfil)
    {
        $uDao = new Usuario_DAO();
        return $uDao -> newUser($nombre, $rut, $apellido, $correo, $idCargo, $idCorredora, $idPerfil);
    }

    public function newUserByIdentifier($identificador, $nombre, $apellido, $correo, $idCargo, $idCorredora, $idPerfil)
    {
        $uDao = new Usuario_DAO();
        return $uDao -> newUserByIdentifier($identificador, $nombre, $apellido, $correo, $idCargo, $idCorredora, $idPerfil);
    }
