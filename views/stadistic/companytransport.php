...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Company Transport</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Transporte Compañía</h3>
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-sm-10 col-xs-6">
                    ...
                    &nbsp;
                    <button id="exportCompanyTransportStadistic" class="btn btn-default" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Exportando"> <i class="fa fa-file-excel-o"></i> Exportar</button>
...
<script>
    $(function() {
        ...
        $("#filter").click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: 'ajax.php?controller=Stadistic&action=companytransportContent',
                data: { fecha: fecha },
                beforeSend: function() {
        ...
        $("#exportCompanyTransportStadistic").click(function() {

            var button = $(this);
            var url='ajax.php?controller=Export&action=ExportCompanyTransport';
            $.ajax({
                type:'POST',
                url: url,
                data: {},
                ...
                $("body").append($a);
                $a.attr("download","EstadisticaCompania.xls");
                $a[0].click();
                $a.remove();
