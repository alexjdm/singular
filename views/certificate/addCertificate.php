        ...
        <form id="newCertificateForm" class="form-horizontal" method="post" action="ajax.php?controller=Certificate&action=createNewCertificate">
            ...
            <div class="modal-body">
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" id="idCertificadoSolicitud" value="<?php echo $certificadoSolicitud['ID_CERTIFICADO']; ?>">

                    <div class="form-group">
                        <label class="col-sm-3 control-label">Solicitud de Certificado</label>
                        <div class="col-sm-9">
                            <p><?php echo utf8_encode($certificadoSolicitud['ORIGEN'] . " a " . $certificadoSolicitud['DESTINO'])  . " el " . FormatearFechaSpa($certificadoSolicitud['FECHA_EMBARQUE']); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="numeroCertificado" type="number" class="form-control">
                        </div>
                    </div>
...
<script type="application/javascript">
    ...
    $('#newCertificateForm').on('submit',(function(e) {
        ...
        if(idCertificadoSolicitud === '' && numeroCertificado === '' && certificado)
        {
