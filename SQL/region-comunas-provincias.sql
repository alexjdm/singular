...
INSERT INTO `region` (`ID_REGION`, `NOMBRE`, `ISO_3166_2_CL`) VALUES
(1, 'Tarapacá', 'CL-TA'),
(2, 'Antofagasta', 'CL-AN'),
(3, 'Atacama', 'CL-AT'),
(4, 'Coquimbo', 'CL-CO'),
...
ALTER TABLE `comuna`ADD CONSTRAINT `comuna_ibfk_1` FOREIGN KEY (`ID_PROVINCIA`) REFERENCES `provincia` (`ID_PROVINCIA`) ON UPDATE CASCADE;

ALTER TABLE `provincia` ADD CONSTRAINT `provincia_ibfk_1` FOREIGN KEY (`ID_REGION`) REFERENCES `region` (`ID_REGION`) ON UPDATE CASCADE;